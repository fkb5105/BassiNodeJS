# Felipe Bassi Revisions

# Three.JS Tutorial - Create 3D Environments with HTML and Javascript

![three.js blog](image/screenshots/threeJSblog.jpg)
...
![VS code terminal](image/screenshots/VScodeTerminal.jpg)
...
- Do not use the default HTML that appears when you open your index.html in your project folder
...
<html>
    ...
    <body>
        <h1>You can create anything you want.</h1>
        <canvas id="bg"></canvas>
...
```
Note: You can add this CSS snippet to the bottom of the default style.css file.
...
- Root Folder (Project name)
  - index.html
  - style.css
  - main.js (You will edit this in the next steps. It's where your project js will be.)
  - counter.js
  - package.json 
  - package-lock.json
  - node_modules (folder)
...
![standard material cube](image/screenshots/standardMaterial.jpg)
...
![three.JS object screenshot](image/screenshots/twoObjects.jpg)
...
```
![light helper](image/screenshots/lightHelper.jpg)
...
![night sky background photo](image/night_sky.jpg)
...
```
![background texture scene](image/screenshots/backgroundTexture.jpg)
...
![smiley face texture](image/smile.jpg)
...
![new texture-mapped object](image/screenshots/textureMapping.jpg)
...
![normal map](image/textureNormal.png)
...
![normal mapping](image/screenshots/normalMapping.jpg)
...
**Step 2**
Copy and paste the following files from the root project folder to the new ```dist``` folder.
...
Note: After installing it you should see in your package.json file under "dependecies" gh-pages and the version you just installed.
...
![New repo screen on Github](image/screenshots/new-repo-remoteGH.jpg)
...
![Github remote repo setup screen](image/screenshots/github-setup-screen.jpg)
...
git push origin master (Type main instead of master if your repo branch is main)
...
![NPM run deploy gh-pages](image/screenshots/npm-run-deploy-publish.jpg)
...
# Note 
At the end of the project your project folder should look like the following:
...
If you have the index.html, style.css and main.js in your root directory as well as in your dist folder don't worry. You can use these files to make corrections and changes locally. Your dist folder files will update automatically when running ***npm run deploy***. 
